...
const About = () => {
  return (
    ...
    <p>We build a close and personal connection with them, so they become "hand-fed" parrots or even trained companions—all done with joy and love. Because of this, the parrots happily cooperate and become wonderful friends to humans.</p>
  
    <p>You are invited to enjoy our blessed activities with the parrots and purchase a parrot that has learned to be friendly and unafraid of people, allowing you to welcome a wonderful pet that can truly brighten your home.</p>
